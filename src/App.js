...
export default function App() {
  ...
  if (screen === 'game' && question)
    return <GameScreen level={level} question={question} onAnswer={handleAnswer} shake={shake} />;
  if (screen === 'result')
    return <ResultScreen correct={lastCorrect} level={level} onNext={handleNext} />;
